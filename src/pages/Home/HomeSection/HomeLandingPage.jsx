...
import Herolanding from "../../../../public/Assets/Videos/HeroLanding.mp4";
import Video from "../../../Components/Common/Video";
const HomeLandingPage = () => {
  return (
    <div className="h-screen w-full ">
      <div className=" backarea  h-full w-full">
        <div className="h-full relative w-full ">
          <Video video={Herolanding} className="h-full w-full object-cover" />
        </div>
        <div className="h-full w-full  absolute top-0 left-0 ">
          <div className="h-full w-full flex items-end   justify-end ">
            <div className=" w-full flex py-4   items-start justify-end flex-col  px-12  text-white  relative">
            ...
            <div className="flex bg-black items-end  justify-center px-8 pt-50 py-8 w-full bg-white absolute top-0 left-0 z-20 text-[#878E90]">
              <svg 
                xmlns="http://www.w3.org/2000/svg"
                width="100%"
                viewBox="0 0 307 68"
                className="hero-svg  text-[#878E90]"
              >
                <path
